      ...
      <div className="max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center">
        <div>
          ...
          <p className="py-4 text-gray-600 max-w-[70%] m-auto">
            ...
            experience.Currently, I'm fucused on building on responsive front-end web designs while
            learning to develop mobile apps while still learning back-end technologies
          </p>
